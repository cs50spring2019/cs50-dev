# $Id: .bash_logout,v 1.1 1997/06/24 05:15:12 testuser Exp $

# This file is sourced by bash at the close of every login shell.  For
# more info type `man bash'.
...
#
#	cp /usr/local/lib/templates/master.bash_logout ~/.bash_logout
#
...
source /usr/local/lib/templates/master.bash_logout
