# $Id: .login,v 1.1 1997/06/24 05:15:12 testuser Exp $

# This file is sourced by csh or tcsh in every login shell.  After
# editing this file, type `source .cshrc' in any shell which is
# already open and in which you want the changes to take effect.  For
# more info type `man csh' or `man tcsh'.
...
#
#	cp /usr/local/lib/templates/master.login ~/.login
#
...
source /usr/local/lib/templates/master.login
